...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('dental_histories', function (Blueprint $table) {
            $table->id();
            $table->string('reason_medical_visit');
            $table->boolean('medications');
            $table->string('wath_medication');
            $table->boolean('dental_trauma');
            $table->string('wath_dental_trauma');
            ...
            $table->string('where_is_pain');
            $table->string('caused_by');
            $table->string('pain_type');
            $table->string('calms_with');
            $table->boolean('gums_bleed');
            $table->boolean('abnormal_lips');
            $table->string('abnormal_lips_linjury');
            $table->boolean('abnormal_cheeks');
            $table->string('abnormal_cheeks_injury');
            $table->boolean('abnormal_gums');
            $table->string('abnormal_gums_ingury');
            $table->boolean('abnormal_palate');
            $table->string('abnormal_palate_injury');
            $table->boolean('abnormal_tongue');
            $table->string('abnormal_tongue_injury');
            $table->boolean('abnormal_under_tongue');
            $table->string('abnormal_under_tongue_injury');
            $table->string('anywhere_else_abnormal');
            $table->string('how_is_injury');
            $table->boolean('injury_has_pus');
            $table->string('when_has_pus');
            $table->boolean('has_ulcers');
            $table->string('when_has_ulcers');
            $table->timestamps();
